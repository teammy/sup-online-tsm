...
// tableRows.push(table1);

// const staticRow = (item:any) => {
//  
// }

const tableRows: any[] = [];
async function fetchData(url: string, tableRows: any[]) {
  try {
    const response = await fetch(url);
    const data = await response.json();
    console.log("Fetched Data2:", data.data);

    data.data.map((item: any, index: number) => {
      const row = [
        { text: index + 1, alignment: "center" },
        { text: item[48] ? item[2] : "", alignment: "center" },
...
// fetchData("https://example.com/data", tableRows);
fetchData('http://localhost:3000/api/sheet?sentDate=2023-08-02&worktime=1', tableRows);
...
// console.log(tableRows);
    ...
    //         },
    //         { 
    //           text: item[46] ? item[46] : "",alignment: 'center' 
    //         },
    //         { text: item[47] ? item[2] : "" ,alignment: 'center' },
    //         { text: item[48] ? item[2] : "",alignment: 'center' },
    //         { text: item[49] ? item[2] : "" ,alignment: 'center' },
    //         { text: item[50] ? item[2] : "",alignment: 'center' },
    //         { text: item[115] ? item[2] : "",alignment: 'center' },
    //         { text: item[116] ? item[2] : "",alignment: 'center' },
    //         { text: item[117] ? item[2] : "",alignment: 'center' },
    //         { text: item[118] ? item[2] : "",alignment: 'center' },
    //         { text: item[119] ? item[2] : "",alignment: 'center' },
    //         { text: item[120] ? item[2] : "",alignment: 'center' },
    //         { text: item[121] ? item[2] : "",alignment: 'center' },
    //         { text: item[122] ? item[2] : "",alignment: 'center' },
    //         { text: item[123] ? item[2] : "",alignment: 'center' },
    //         { text: item[137] ? item[2] : "",alignment: 'center' },
    //         "",
    //         { text: item[155] ? item[2] : "",alignment: 'center' },
    //         { text: item[156] ? item[2] : "",alignment: 'center' },
    //         { text: item[157] ? item[2] : "",alignment: 'center' },
    //         { text: item[158] ? item[2] : "",alignment: 'center' },
    //         { text: item[159] ? item[2] : "",alignment: 'center' },
    //         { text: item[160] ? item[2] : "" },
    //   ];
