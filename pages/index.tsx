    ...
    async function fetchData() {
      try {
        const response = await fetch(
          ...
          `/api/sheet?sentDate=${selectedDate}&worktime=${selectedShift}`
        );
      ...
      if (item[3] === 'MICU') {
        const rowMicu = [
          { text: index+1,alignment: 'center'
              ...
              { text: item[165],alignment: 'center' },
              { text: item[166],alignment: 'center' },
      ...
      if (item[3] === 'หอผู้ป่วยศัลยกรรมชาย') {
        ...
        [
          { text: ""
              ...
              { text: item[163],alignment: 'center' },
              { text: item[164],alignment: 'center' },
          ...
          table: {
            ...
            body: [
              [
                ...
                { 
                  colSpan: 11, 
                  text: "ข้อมูลผู้ป่วย",alignment: "center",margin: [0, 8, 0, 0], },
                "",
                "",
                "",
                "",
              ...
              [
                ...
                { colSpan: 3, text: "Ven",margin: [0, 1, 0, 0],alignment: 'center' },
                "uu",
                "yy",
                ...
                { colSpan: 2, text: "Refer",alignment: 'center',margin: [0, 1, 0, 0] },
                "15",
          ...
          table: {
            ...
            body: [
              [
                ...
                "",
                "",
                { rowSpan: 2, text: "รายชื่อ\nหัวหน้าเวร",alignment: "center",margin: [0, 0, 0, 0] }, 
              ],
